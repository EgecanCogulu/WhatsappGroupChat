...
ax.set_ylim(0,215)
ax2 = ax.twinx()
ax2.set_ylabel('Tüm "G" lere Oranı (%)',fontsize=13)
fullscale=np.round(215/sum(numberofGs),2)*100
ax2.set_yticks(np.asfarray([0,0.2,0.4,0.6,0.8,1])*fullscale)
plt.tight_layout()
plt.tight_layout()
plt.savefig(r"C:\Users\Egecan\Desktop\Output\Atılan Toplam G.png",dpi=600)
...
ax.set_xticklabels(namelist, rotation=90,horizontalalignment="center")
plt.tight_layout()
plt.savefig(r"C:\Users\Egecan\Desktop\output\G Mesaj Oranı.png",dpi=600)
