...
people=['Çağan', 'Ali', 'Metin', 'Gogo', 'Alp', 'Şizo', 'Eren', 'Palamut', 'Cemil', 
        ...
        'Koko', 'Bambam', 'Mert Arin', 'Cem Alço', 'Semih Anıl', 'Taylan', 'Eray Er', 'Gaşşar',
...
plt.tight_layout()
plt.savefig(r"C:\Users\Egecan\Desktop\output\Mesaj.png",dpi=600)


# fig,ax=plt.subplots()
# plt.ylabel("Mesaj Sayısı (Logaritmik)",size=13)
# plt.title("2020 Nisan - Aralık Aylarında Atılan Mesajlar",size=13)
# plt.text(20,5500,"Toplam Mesaj: %2d" %(sum(numberofmessages)))
# plt.bar(namelist,numberofmessages,color=my_cmap(my_norm(numberofmessages)),  edgecolor='black')
# ax.set_yscale('log')
# ax.set_xticklabels(namelist, rotation=90,horizontalalignment="center")
# plt.tight_layout()
# plt.savefig(r"C:\Users\Egecan\Desktop\output\Mesaj_log.png",dpi=600)
...
plt.tight_layout()
plt.savefig(r"C:\Users\Egecan\Desktop\output\2 - Aylara Göre Dağılım.png",dpi=600)
...
plt.title("Saatlere Göre Dağılım",size=13)
plt.ylabel("Mesaj Sayısı",size=13)
plt.xlabel("Saat (GMT+3)",size=13)
plt.tight_layout()
plt.savefig(r"C:\Users\Egecan\Desktop\output\3 - Saatlere Göre Dağılım.png",dpi=600)
