# -*- coding: utf-8 -*-
"""
Created on Fri May  1 23:02:07 2020
...
my_norm =SymLogNorm(linthresh=0.03, linscale=0.03, base=2,vmin=5, vmax=190)
fig,ax=plt.subplots()


plt.ylabel("Emoji Sayısı",size=15)
plt.title("Toplam Emoji Sayısı: %d" %(sum(numberofmessages)))
