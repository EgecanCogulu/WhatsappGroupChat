...
plt.ylabel("Karakter/Mesaj",size=15)
plt.title("Mesaj Başına Ortalama Karakter Sayısı")
...
plt.tight_layout()
plt.savefig(r"C:\Users\Egecan\Desktop\Ortalama Karater Mesaj.png",dpi=600)